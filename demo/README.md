...
We've uploaded the model trained with 239 samples from the LISA dataset（<a href="https://huggingface.co/Zery/Qwen2-VL-7B_visual_rft_lisa_IoU_reward">🤗Huggingface</a>）. You can use the following code for inference to test the model's **reasoning grounding** capability.
```python
import torch
