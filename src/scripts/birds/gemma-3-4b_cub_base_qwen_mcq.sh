...
export LOG_PATH="./logs/debug_log_gemma3-4b-cub_base_gemma_mcq.txt"
...
export SAVE_PATH=/app/saved_models/vrft/CUB_200_2011/gemma3-4b_GRPO_cub_base_gemma_mcq
export RUN_NAME=gemma3-4b_GRPO_cub_base_gemma_mcq
